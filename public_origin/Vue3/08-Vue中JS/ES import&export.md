[ES 模块语法](https://www.rollupjs.com/es-module-syntax/#named-imports)
...
## [导入](https://www.rollupjs.com/es-module-syntax/#importing)

导入的值不能被重新分配，尽管导入的对象和数组 *可以* 被 mutated（并且导出模块和任何其他导入将受到 mutation 的影响）。也就是说，它们的行为类似于 const 声明。

### [具名导入](https://www.rollupjs.com/es-module-syntax/#named-imports)
...
### [名称空间导入](https://www.rollupjs.com/es-module-syntax/#namespace-imports)
...
### [默认导入](https://www.rollupjs.com/es-module-syntax/#default-import)
...
### [无命名导入](https://www.rollupjs.com/es-module-syntax/#empty-import)
...
### [动态导入](https://www.rollupjs.com/es-module-syntax/#dynamic-import)
...
## [导出](https://www.rollupjs.com/es-module-syntax/#exporting)

### [具名导出](https://www.rollupjs.com/es-module-syntax/#named-exports)
...
### [默认导出](https://www.rollupjs.com/es-module-syntax/#default-export)
